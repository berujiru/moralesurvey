...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return ((get_class(Yii::app())=='CConsoleApplication' || (get_class(Yii::app())!='CConsoleApplication' && Yii::app()->getModule('user')->isAdmin()))?array(
			...
			array('password', 'length', 'max'=>128, 'min' => 3,'message' => UserModule::t("Incorrect password (minimal length 4 symbols).")),
			array('email', 'email'),
	...
	public function relations()
	{
        ...
        if (!isset($relations['position']))
            $relations['position'] = array(self::HAS_ONE, 'Position', 'user_id');
        if (!isset($relations['division']))
            $relations['division'] = array(self::HAS_ONE, 'Division', 'user_id');
        if (!isset($relations['moraleconfig']))
        	 $relations['moraleconfig'] = array(self::HAS_ONE, 'Moraleconfig', 'user_id');
        return $relations;
	}
...
/**
	...
	public function getColor() {
        ...
        $statuscolor='white';
        if($this->position){
        	switch (strtolower($this->position->position_type)) {
            case "regular":
                $statuscolor='green';
                break;
            case "project_base":
