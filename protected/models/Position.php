...
class Position extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('user_id, position_type', 'required'),
			array('user_id', 'numerical', 'integerOnly'=>true),
			array('position_id', 'length', 'max'=>50),
			array('position_type', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, user_id, position_id, position_type', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('position_type',$this->position_type,true);
